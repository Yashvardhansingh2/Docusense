...
PDF_PATH = pathlib.Path('/Users/yash/Downloads/unit1.pdf')
...
def main() -> int:
    ...
    with httpx.Client(timeout=180.0) as client:
        ...
        chunk_payload = {
            'doc_id': doc_id,
            'question': 'Summarize the main topics covered in this unit.',
            'top_k': 3,
        }
        ...
        query_payload = {
            'doc_id': doc_id,
            'question': 'What are the key points from this unit?',
        }
